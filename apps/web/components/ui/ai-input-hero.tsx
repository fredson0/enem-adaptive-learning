...
export function HeroWave({
  ...
  useEffect(() => {
    ...
    function step() {
      ...
      const suggestionList = suggestionsRef.current;
      const current =
        suggestionList[state.suggestionIndex % suggestionList.length] || "";
      ...
      if (!state.deleting) {
        ...
        if (nextIndex <= 0) {
          ...
          state.suggestionIndex =
            (state.suggestionIndex + 1) % suggestionList.length;
  ...
  useEffect(() => {
    ...
    function createInstancedMaterial() {
      const baseCol = new THREE.Color("#1e3a8a");
      const emisCol = new THREE.Color("#3b82f6");
  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        width: "100%",
        height: variant === "workspace" ? "100%" : "100vh",
        backgroundColor:
          variant === "workspace" ? "var(--osmo-surface)" : undefined,
        ...style,
      }}
